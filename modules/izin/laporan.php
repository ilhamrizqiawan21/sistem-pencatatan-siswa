...
<div class="card mb-4">
    ...
    <div class="card-body">
        ...
        <div class="form-text text-muted mt-2">
            <i class="fas fa-info-circle"></i> Kosongkan rentang tanggal untuk menampilkan semua data izin.
        </div>
    </div>
</div>
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?= $r['jumlah'] ?></td>
                            <td><a href="detail_siswa.php?siswa_id=<?= $r['id'] ?>&tanggal_mulai=<?= urlencode($tanggal_mulai) ?>&tanggal_selesai=<?= urlencode($tanggal_selesai) ?>&kelas_id=<?= $kelas_id ?>" class="btn btn-sm btn-info">Detail</a></td>
                        </tr>
                        <?php endforeach; ?>
                    </tbody>
                </table>
